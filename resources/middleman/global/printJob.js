...
middleman.printJob = function () {
	function printDiv(to_name, to_nr, owner_nr) {
		...
		newWindow.document.write(`
			<html><head><title>NP Converter Print View</title>
			...
			`);
		newWindow.document.write('<body id="capture">');
		newWindow.document.write('<div class="banner">' + pageDate.head + '</div>');
		newWindow.document.write(`
		<div class="help">
		<hr class="helphr">
		...
		`);
		newWindow.document.write('<div class="logBody"><div class="output" style="grid-area: 1/1/5/7"><div class="messages">' + pageDate.log + '</div></div></div>');
		newWindow.document.write('<footer>' + pageDate.footer + '</footer>');
