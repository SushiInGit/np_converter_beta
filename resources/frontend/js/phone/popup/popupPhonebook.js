...
frontend.popupPhonebook = (function () {
    function phonebookEvent() {
        ...
        `;
        const footer = `
         <button class="ok" onclick="frontend.popupPhonebook.sendPhonebookImport();">Update contacts</button> <button class="risk hide" onclick="frontend.popupPhonebook.forceSavePhonebookImport();">Update anyway</button>
        `;
